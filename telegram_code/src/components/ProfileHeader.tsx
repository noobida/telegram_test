  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Profile image as background with blur and overlay */}
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage: `url('/profile image.png')`,
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('/background only image.png')",
          }}
        />
        
        {/* Gradient overlay for better contrast */}
        <div className="absolute inset-0 bg-gradient-to-b from-purple-600/60 via-purple-700/70 to-purple-800/80" />
      </div>
